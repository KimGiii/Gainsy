...
- [ ] **Xcode Archive build 4 → TestFlight 업로드** ← 다음 단계 (광고 코드 복원 완료)
...
**마지막 업데이트**: 2026-05-15 (Phase 6 95% — iPad 13" 스크린샷 완료, build 4 TestFlight 업로드·심사 제출 대기)
