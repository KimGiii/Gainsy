...
1. 홈/마이/기록 화면 회귀 점검 및 스타일 일관성 보강
2. 접근성 점검 (Dynamic Type, VoiceOver 기본 대응)
3. 로딩/에러/빈 상태 화면 일관성 정리
4. TestFlight 배포 전 체크리스트 문서화
...
**마지막 업데이트**: 2026-05-05 (iOS APIClient refresh/401 재시도 및 UI smoke 테스트 통과)
