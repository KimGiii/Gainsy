...
Phase 0~5 모두 100% 완료. BLOCKER 6개 완료. App Store Connect 메타데이터·스크린샷·앱 심사 정보·가격·Privacy Labels(추적 포함) 모두 입력 완료. iPad 13" 스크린샷 업로드 → build 4 TestFlight 업로드 → 심사 제출이 남아 있다.
...
- [ ] **13" iPad** — 2064×2752 또는 2048×2732 (심사 제출 필수 요건)
...
7. [ ] **iPad 13" 스크린샷 업로드** (iPad Pro 13" 시뮬레이터 캡처, 2064×2752)
8. [ ] **Xcode Archive build 4 → TestFlight 업로드** (광고 코드 복원 완료)
9. [ ] **심사 제출** (build 4 선택 후 제출)
